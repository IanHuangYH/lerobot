...
cd /workspace/lerobot/pi_setting/eval && python preserve_exact_positions.py \
    ...
    --old_init /workspace/lerobot/third_party/LIBERO/libero/libero/init_files/libero_spatial/pick_up_the_black_bowl_between_the_plate_and_the_ramekin_and_place_it_on_the_plate.init \
