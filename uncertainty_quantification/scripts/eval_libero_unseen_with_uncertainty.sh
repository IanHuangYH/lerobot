...
OUTPUT_DIR="uncertainty_quantification/eval_log/vlm_general_attention_rnd_long_object_unseen"
TASK_SUITE=libero_unseen_object  # libero_spatial,libero_object,libero_goal,libero_10,libero_unseen_object
RND_MODELS_DIR="uncertainty_quantification/rnd_save_models_long_150"  # Directory containing trained RND models
